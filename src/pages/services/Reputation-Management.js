    ...
    return (
      <>
        <section className="content">
          <PageHeader page="repman" title="Online Reputation Management Services" background="handsonlaptop" />
              ...
              <div className="row">
                ...
                <div className="col-3 service no-padding">
                  ...
                  <div className="bottom">
                    <p><Link to="/blog/content-is-still-king-content-development-strategies-for-online-reputation-management/">Content Control</Link></p>
                    <p>We offset undesirable search results by creating positive, highly optimized online assets.</p>
                    <Link to="/blog/content-is-still-king-content-development-strategies-for-online-reputation-management/" className="btn btn-blue">Learn More</Link>
                  </div>
                </div>
                ...
                <div className="col-3 service no-padding">
                  ...
                  <div className="bottom">
                    <p><Link to="/services/reputation-management/auto-suggest-solutions/">Syndicated Searches</Link></p>
                    <p>We direct traffic to new content we have developed to increase rankings.</p>
                    <Link to="/services/reputation-management/auto-suggest-solutions/" className="btn btn-blue">Learn More</Link>
                  </div>
                </div>
                ...
                <div className="col-3 service no-padding">
                  ...
                  <div className="bottom">
                    <p><Link to="/blog/7-ways-to-bury-negative-content-on-google/">Suppression</Link></p>
                    <p>We identify effective platforms and optimal content types to impact search results.</p>
                    <Link to="/blog/7-ways-to-bury-negative-content-on-google/" className="btn btn-blue">Learn More</Link>
                  </div>
                </div>
                ...
                <div className="col-3 service no-padding">
                  ...
                  <div className="bottom">
                    <p><Link to="/blog/everything-about-removing-articles-online/">Executive Monitoring</Link></p>
                    <p>In an uninfluenced search page, we track, relay, and remove any potential risks or threats.</p>
                    <Link to="/blog/everything-about-removing-articles-online/" className="btn btn-blue">Learn More</Link>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="section whiteBkg photoLeft">
            <div className="container">
              <div className="row">
                <div className="col-6">
                  <img src={process.env.PUBLIC_URL + '/global/images/graphics/fix-your-reputation.png'} className="responsive rounded" alt="Reputation Tachomoter" />
                </div>
